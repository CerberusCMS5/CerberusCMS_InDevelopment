...
include_once ("./Theme/$_INTERNAL_FILE_ARCHITECT_INSTALL_DIRECTORY_THEME_VIDEO_RESOLUTION/Global/Theme.php");
...
echo ("
		...
		<IMG SRC=\"./Theme/$_INTERNAL_FILE_ARCHITECT_INSTALL_DIRECTORY_THEME_VIDEO_RESOLUTION/Global/Image/Icon_Architect/Compass.png\" WIDTH=\"125\" HEIGHT=\"125\" TITLE=\":: Architect :: Compass ::\"></IMG>
		...
		* <I>Enable or Disable System-Level Electronic Mail Message Pretty-Good-Privacy Encryption Now ? </I>:<BR>
			...
			Pretty-Good-Privacy Key Panel :: Public :: System Web Server Notification Messages<BR>
			...
			Pretty-Good-Privacy Key Panel :: Public :: System Services-Root Administration Messages<BR>
			...
			Pretty-Good-Privacy Key Panel :: Public :: System Background-Services Notification Messages<BR>
...
$_ARCHITECT_INSTALLATION_DATABASE_DATA_CONNECT_INITIALIZE->query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Emulators','011','?Application_Member&#61;Emulators','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
...
$_ARCHITECT_INSTALLATION_DATABASE_DATA_CONNECT_INITIALIZE->query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications(application_file_integrity,application_file_integrity_installation,application_file_name,application_file_permission,application_file_permission_camera,application_file_permission_microphone,application_file_permission_location_gps,application_file_permission_location_glo,application_file_permission_location_internet_protocol_address,application_file_status,application_file_timestamp_installation,application_file_version)VALUES('$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_019','$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_019','Emulators','0','1','1','1','1','1','1','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP','$_PROJECT_VERSION_FILE_NUMBER')");
...
copy("./Theme/$_INTERNAL_FILE_ARCHITECT_INSTALL_DIRECTORY_THEME_VIDEO_RESOLUTION/$_INTERNAL_FILE_ARCHITECT_INSTALL_DIRECTORY_THEME_NAME/Image/Icon_Avatar/$_INTERNAL_FILE_ARCHITECT_INSTALL_ROOT_ACCOUNT_USERNAME.png","./Member/$_PROJECT_STRING_NAME_SHORT/Files/Image/Profile/Backup/Profile.png");
copy("./Theme/$_INTERNAL_FILE_ARCHITECT_INSTALL_DIRECTORY_THEME_VIDEO_RESOLUTION/$_INTERNAL_FILE_ARCHITECT_INSTALL_DIRECTORY_THEME_NAME/Image/Icon_Avatar/$_INTERNAL_FILE_ARCHITECT_INSTALL_ROOT_ACCOUNT_USERNAME.png","./Member/$_PROJECT_STRING_NAME_SHORT/Files/Image/Profile/Profile.png");
	echo ("[ Done ]<BR><BR>");
...
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND						= "./Applications/Background";
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_CUSTOM							= "./Applications/Custom";
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER							= "./Applications/Member";
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MODERATOR						= "./Applications/Moderator";
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PAGES							= "./Applications/Pages";
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL							= "./Applications/Panel";
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PUBLIC							= "./Applications/Public";
...
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_009							= hash_file('sha256', "./Applications/Panel/Live_Video.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_010							= hash_file('sha256', "./Applications/Panel/Location.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_011							= hash_file('sha256', "./Applications/Panel/Media_Player.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_012							= hash_file('sha256', "./Applications/Panel/Member_Panel.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_013							= hash_file('sha256', "./Applications/Panel/Moderator.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_014							= hash_file('sha256', "./Applications/Panel/Networking.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_015							= hash_file('sha256', "./Applications/Panel/Project_Badges.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_016							= hash_file('sha256', "./Applications/Panel/RSS_Panel.panel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_017							= hash_file('sha256', "./Applications/Panel/Theme.panel");

/*
 ============================================================================================================
 + Retrieve :: File Integrity :: Applications :: Public
 ============================================================================================================
*/

$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PUBLIC_FILE_001							= hash_file('sha256', "./Applications/Public/Engine_Validation");
...
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_ADMINISTRATION_FILE_007					= hash_file('sha256', "./Applications/Administration/File_Manager");
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_ADMINISTRATION_FILE_008					= hash_file('sha256', "./Applications/Administration/Forum");
$_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_ADMINISTRATION_FILE_009					= hash_file('sha256', "./Applications/Administration/GIT");
...
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_043							= hash_file('sha256', "./Applications/Member/System");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_044							= hash_file('sha256', "./Applications/Member/System_Message");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_045							= hash_file('sha256', "./Applications/Member/Theme");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_046							= hash_file('sha256', "./Applications/Member/Travel");
$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_047							= hash_file('sha256', "./Applications/Member/Update_Account");
...
/*
 ============================================================================================================
 + Retrieve :: File Integrity :: Applications :: Moderator
 ============================================================================================================
*/

$_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MODERATOR_FILE_001							= hash_file('sha256', "./Applications/Moderator/Forum");

echo ("<HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Administration<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");
...
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_ADMINISTRATION_FILE_025 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_ADMINISTRATION/Web_Pages<BR>");

echo ("<BR><HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Background<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");

echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_BACKGROUND_FILE_001 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/Log_Administration<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_BACKGROUND_FILE_002 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/Log_Background<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_BACKGROUND_FILE_003 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/Log_Member<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_BACKGROUND_FILE_004 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/Log_Visitor<BR>");

echo ("<BR><HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Member<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");

echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_001 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Account_Data<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_002 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Account_Recovery<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_003 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Active_Members<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_004 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/All_News<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_005 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/All_Shouts<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_006 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Application_List<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_007 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Articles<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_008 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Calculator<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_009 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Calendar<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_010 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Clock<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_011 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Comment<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_012 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Contact_Administrator<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_013 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Contacts<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_014 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Control_Panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_015 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Devices<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_016 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Documentation<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_017 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Download<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_018 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Electronic_Mail<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_019 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Emulators<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_020 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Files<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_021 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Forum<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_022 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Forward<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_023 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Friend<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_024 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Language<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_025 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Legal<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_026 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Lightning_Calculate<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_027 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/List<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_028 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Login<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_029 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Market<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_030 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Media_Player<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_031 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Member_Directory<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_032 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Messenger<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_033 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/News<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_034 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Notepad<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_035 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Pages<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_036 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Profile<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_037 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Recommendations<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_038 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Referrers<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_039 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Register<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_040 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Reset_Password<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_041 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Search<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_042 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Submit_News<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_043 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/System<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_044 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/System_Message<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_045 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Theme<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_046 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Travel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_047 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Update_Account<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_048 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Update_Password<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_049 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Upload<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_050 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/VoIP<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MEMBER_FILE_051 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/Webspace<BR>");

echo ("<BR><HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Moderator<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");

echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_MODERATOR_FILE_001 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_MODERATOR/Forum<BR>");

echo ("<BR><HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Panel<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");

echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_001 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Administration.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_002 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Applications_Panel.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_003 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Clock.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_004 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Language.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_005 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Latest_Articles.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_006 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Latest_Files.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_007 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Latest_Members.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_008 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Latest_Shouts.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_009 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Live_Video.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_010 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Location.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_011 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Media_Player.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_012 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Member_Panel.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_013 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Moderator.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_014 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Networking.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_015 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Project_Badges.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_016 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/RSS_Panel.panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PANEL_FILE_017 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PANEL/Theme.panel<BR>");

echo ("<BR><HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Public<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");

echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_PUBLIC_FILE_001 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_PUBLIC/Engine_Validation<BR>");

echo ("<BR><HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Root<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");

echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_ROOT_ADMINISTRATION_FILE_001 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_ROOT_ADMINISTRATION/Tasks<BR>");

echo ("<BR><HR ALIGN=\"LEFT\" WIDTH=\"25%\">Finding File Integrity :: For :: Directory and Files :: ./Applications/Services<HR ALIGN=\"LEFT\" WIDTH=\"25%\">");

echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_SERVICES_ROOT_ADMINISTRATION_FILE_001 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_SERVICES_ROOT_ADMINISTRATION/Commander<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_SERVICES_ROOT_ADMINISTRATION_FILE_002 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_SERVICES_ROOT_ADMINISTRATION/Control_Panel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_SERVICES_ROOT_ADMINISTRATION_FILE_003 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_SERVICES_ROOT_ADMINISTRATION/Integrity<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_SERVICES_ROOT_ADMINISTRATION_FILE_004 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_SERVICES_ROOT_ADMINISTRATION/Kernel<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_SERVICES_ROOT_ADMINISTRATION_FILE_005 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_SERVICES_ROOT_ADMINISTRATION/Loops<BR>");
echo ("* Finding File Integrity For File: $_ARCHITECT_INTEGRITY_FILES_FIND_APPLICATION_SERVICES_ROOT_ADMINISTRATION_FILE_006 :: $_ARCHITECT_INTEGRITY_FILES_FIND_DIRECTORY_APPLICATION_SERVICES_ROOT_ADMINISTRATION/Services<BR>");
...
echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Background<HR>");

$_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL			= "0444";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND			= "./Applications/Background";
$_ARCHITECT_PERMISSIONS_FILES_OPEN_DIRECTORY_APPLICATION_BACKGROUND			= opendir($_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND);

$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_001		= "Log_Administration";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_002		= "Log_Background";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_003		= "Log_Member";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_004		= "Log_Visitor";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_005		= "index.php";

chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_001", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL));
echo ("Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL On File: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_001<BR>");

chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_002", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL));
echo ("Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL On File: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_002<BR>");

chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_003", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL));
echo ("Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL On File: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_003<BR>");

chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_004", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL));
echo ("Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL On File: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_004<BR>");

chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND/$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_005", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL));
echo ("Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL On File: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND_FILE_005<BR>");

chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL));
echo ("<BR>Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_BACKGROUND_VALUE_OCTAL On Directory: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_BACKGROUND<BR>");
...
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_013		= "Contacts";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_014		= "Control_Panel";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_015		= "Devices";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_016		= "Documentation";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_017		= "Download";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_018		= "Electronic_Mail";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_019		= "Emulators";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_020		= "Files";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_021		= "Forum";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_022		= "Forward";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_023		= "Friend";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_024		= "Language";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_025		= "Legal";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_026		= "Lightning_Calculate";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_027		= "List";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_028		= "Login";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_029		= "Market";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_030		= "Media_Player";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_031		= "Member_Directory";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_032		= "Messenger";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_033		= "News";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_034		= "Notepad";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_035		= "Pages";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_036		= "Profile";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_037		= "Recommendations";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_038		= "Referrers";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_039		= "Register";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_040		= "Reset_Password";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_041		= "Search";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_042		= "Submit_News";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_043		= "System";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_044		= "System_Message";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_045		= "Theme";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_046		= "Travel";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_047		= "Update_Account";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_048		= "Update_Password";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_049		= "Upload";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_050		= "VoIP";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_051		= "Webspace";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_052		= "index.php";
...
chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER/$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_052", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL));
echo ("Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL On File: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_052<BR>");

chmod("$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER", octdec($_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL));
echo ("<BR>Architect: Message: Change-Mode File Permissions Were Set To: $_ARCHITECT_PERMISSIONS_FILES_VALUE_APPLICATIONS_MEMBER_VALUE_OCTAL On Directory: $_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER<BR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Custom<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Member<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Moderator<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Pages<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Panel<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Public<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Root<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Services<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications/Video_Games<HR>");

echo ("<HR>Setting File Permissions :: For :: Directory :: ./Applications<HR>");
